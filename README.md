...
|---|---|---|---|
| <img src="assets/arsy-code-mark.svg" width="28"> | **arsy-code** | Local, auditable, model-independent software-engineering agent harness | `scoop install arsy-code` |
...
Repository: [suiflex/arsy-code](https://github.com/suiflex/arsy-code).

```powershell
scoop install arsy-code
scoop update arsy-code
scoop uninstall arsy-code
```
...
Diagnose the environment or inspect setup:
...
| File | Generated by |
|---|---|
| `bucket/arsy-code.json` | [`release.yml`](https://github.com/suiflex/arsy-code/blob/main/.github/workflows/release.yml) in `suiflex/arsy-code` |
